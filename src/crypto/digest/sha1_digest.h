...
//
#ifndef CYBERLIB_BUILD_SHA1_DIGEST_H
#define CYBERLIB_BUILD_SHA1_DIGEST_H

#include "idigest.h"

namespace cyber {

class Sha1Digest : public IDigest {
public:
    Sha1Digest();
    ~Sha1Digest() override;
    ...
    // The out buffer size must be greater than 20
...
#endif //CYBERLIB_BUILD_SHA1_DIGEST_H
