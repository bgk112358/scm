...
bool Sha256Digest::Update(const unsigned char *data, unsigned int len) {
...
bool Sha256Digest::Final(unsigned char *out, unsigned int *out_len) {
...
bool Sha256Digest::Compute(const unsigned char *ucInData, unsigned int uiInDataLen,
