...
//
#ifndef CYBERLIB_BUILD_ECC_KEYPAIR_H
#define CYBERLIB_BUILD_ECC_KEYPAIR_H

#include "ikeypair.h"

namespace cyber {

class EccKeyPair : public IKeyPair {
    ...
    bool ImportRawPrivateKey(const std::string& sParams,
                             std::vector<unsigned char> &vRawKey) override;
...
#endif //CYBERLIB_BUILD_ECC_KEYPAIR_H
