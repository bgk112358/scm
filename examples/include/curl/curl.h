...
#define CURLOPT_SERVER_RESPONSE_TIMEOUT CURLOPT_FTP_RESPONSE_TIMEOUT
  ...
  */
  ...
  /* cyber_Header: keeping GMTLS certificate and private key */
  CURLOPT(CURLOPT_GMTLS_SIGN_SSLCERTTYPE, CURLOPTTYPE_STRINGPOINT, 316),
  CURLOPT(CURLOPT_GMTLS_SIGN_SSLCERT, CURLOPTTYPE_STRINGPOINT, 317),
  CURLOPT(CURLOPT_GMTLS_SIGN_SSLKEY, CURLOPTTYPE_STRINGPOINT, 318),
  CURLOPT(CURLOPT_GMTLS_ENC_SSLCERTTYPE, CURLOPTTYPE_STRINGPOINT, 319),
  CURLOPT(CURLOPT_GMTLS_ENC_SSLCERT, CURLOPTTYPE_STRINGPOINT, 320),
  CURLOPT(CURLOPT_GMTLS_ENC_SSLKEY, CURLOPTTYPE_STRINGPOINT, 321),
  CURLOPT(CURLOPT_GMTLS_SIGN_SSLCERT_BLOB, CURLOPTTYPE_BLOB, 322),
  CURLOPT(CURLOPT_GMTLS_SIGN_SSLKEY_BLOB, CURLOPTTYPE_BLOB, 323),
  CURLOPT(CURLOPT_GMTLS_ENC_SSLCERT_BLOB, CURLOPTTYPE_BLOB, 324),
  CURLOPT(CURLOPT_GMTLS_ENC_SSLKEY_BLOB, CURLOPTTYPE_BLOB, 325),
